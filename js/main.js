 ...
 */
var hasTouch="ontouchstart"in document.documentElement,startEvent=hasTouch?"touchstart":"mousedown",moveEvent=hasTouch?"touchmove":"mousemove",endEvent=hasTouch?"touchend":"mouseup";hasTouch&&($.each(["touchstart","touchmove","touchend"],function(a,b){jQuery.event.fixHooks[b]=jQuery.event.mouseHooks}));
